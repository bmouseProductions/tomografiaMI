...
import exame1 from '../../assets/image/exames/exameExecutando.png'

export default function Section1(){
    return (
        <section className="px-5 md:px-16 lg:px-40 py-5 md:py-20 flex flex-col-reverse md:flex-row items-center gap-5 bg-gradient-to-r from-slate-900 to-[#009637] text-white">
